...
<s:form action="register" method="post">
    ...
    <s:textfield name="loginUser.phone" key="register.phone.label"/><BR>
    <s:textfield name="loginUser.address" key="register.address.label"/><BR>
    <s:textfield name="loginUser.email" key="register.email.label"/><BR>
    <s:textfield name="loginUser.zipcode" key="register.zipcode.label"/><BR>
    <s:textfield name="loginUser.fax" key="register.fax.label"/><BR>
